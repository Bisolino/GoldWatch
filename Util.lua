...
function GW.Util.FormatMoneyShort(copper)
    ...
    -- 1K = 1000 gold = 10,000,000 copper
    if copper >= 10000000 then -- 1,000g+ (1K+)
        return format("%s%.3fK", negative and "-" or "", copper / 10000000)
...
function GW.Util.CreateLabel(parent, text, point, relative, relPoint, x, y, color, font)
